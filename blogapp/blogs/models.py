...
class Category(models.Model):
    category_text = models.CharField(max_length=30,default='Unnamed')
    class Meta:
...
class Post(models.Model):
    ...
    body = models.TextField(default='bodyless')
...
class Comment(models.Model):
    ...
    body = models.TextField(default='commentless')
    created_on = models.DateTimeField(auto_now_add=True)
    post = models.ForeignKey('Post',on_delete=models.CASCADE)
    def __str__(self):
        return f"{self.author} of '{self.post}'"
